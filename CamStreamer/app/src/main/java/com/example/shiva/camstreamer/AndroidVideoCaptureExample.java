...
public class AndroidVideoCaptureExample extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (checkSelfPermission(Manifest.permission.CAMERA)
            ...
            requestPermissions(new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAPTURE_VIDEO_OUTPUT},
                    123);
        }
    ...
    public void initialize() {
        cameraPreview = (LinearLayout) findViewById(R.id.llpreview);
        ...
        switchCamera = (Button) findViewById(R.id.btnChange);
